...
module exception_manager(
				...
				*********************************/
				//Commit & Regist Info
				input	[5:0]			iCOREINFO_COMMIT_COUNTER,
				input					iCOREINFO_EXCEPTION_PROTECT,	
				//Scheduler1
				input	[31:0]			iCOREINFO_CURRENT_PC,
				//Free
				output					oCOREINFO_FREE_INST_DISCARD,
				output					oCOREINFO_FREE_EVENT,
				output	[5:0]			oCOREINFO_FREE_COMMIT_TAG,
				output					oCOREINFO_FREE_ADDR_SET,
				output	[31:0]			oCOREINFO_FREE_ADDR,
				output					oCOREINFO_FREE_RESTART,
				output	[31:0]			oCOREINFO_FREE_CURRENT_PC,
				output					oCOREINFO_FREE_SET_IRQ_MODE,
				output					oCOREINFO_FREE_CLR_IRQ_MODE,
				//output	[31:0]			oCOREINFO_FREE_NEW_PSR,	
				output					oCOREINFO_FREE_NEW_SPR_VALID,	
				output	[31:0]			oCOREINFO_FREE_NEW_SPR,
				//Order
				output					oCOREINFO_MCODE0_VALID,
				output	[31/*mitei*/:0]		oCOREINFO_MCODE0,
				output					oCOREINFO_MCODE1_VALID,
				output	[31/*mitei*/:0]		oCOREINFO_MCODE1,
				input					iCODEINFO_MCODE_LOCK,
				//System Register Info
				input	[31:0]			iCOREINFO_SYSREG_IDTR,
				input	[31:0]			iCOREINFO_SYSREG_TISR,
				input	[31:0]			iCOREINFO_SYSREG_TIDR,
				input	[31:0]			iCOREINFO_SYSREG_PSR,
				input	[31:0]			iCOREINFO_SYSREG_PPSR,
				input	[31:0]			iCOREINFO_SYSREG_PPCR,
				input	[31:0]			iCOREINFO_SYSREG_SPR,
				//IO Port
				output					oLDST_USE,
				output					oLDST_REQ,
				input					iLDST_BUSY,
				...
				*********************************/
				//ALU Branch
				input					iALU_BRANCH_REQ,
				input	[31:0]			iALU_BRANCH_ADDR,
				input	[5:0]			iALU_BRANCH_COMMIT_TAG,
				//IRQ-Ret
				input					iALU_INTRET_REQ,
				input	[31:0]			iALU_INTRET_ADDR,
				input	[5:0]			iALU_INTRET_COMMIT_TAG,
				//IDT Set
				input					iIDT_SET_REQ,
				input	[31:0]			iIDT_SET_R_ADDR,
				input	[5:0]			iIDT_SET_COMMIT_TAG,
				input	[31:0]			iIDT_SET_IDTR,
				//Hardware Task Switch
				input					iHW_TS_REQ,
				input	[31:0]			iHW_TS_ADDR,
				output					oHW_TS_BUSY,
				//IRQ-Set
				input					iIRQ_REQ,
				input	[6:0]			iIRQ_NUM,
