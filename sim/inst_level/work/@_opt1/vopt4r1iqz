...
entity reservation_alu1_entry is
    port(
        ...
        iREGIST_DESTINATION_SYSREG: in     vl_logic;
        iREGIST_WRITEBACK: in     vl_logic;
        iREGIST_CMD     : in     vl_logic_vector(4 downto 0);
        iREGIST_AFE     : in     vl_logic_vector(3 downto 0);
        iREGIST_SYS_REG : in     vl_logic;
        iREGIST_LOGIC   : in     vl_logic;
        iREGIST_SHIFT   : in     vl_logic;
        iREGIST_ADDER   : in     vl_logic;
        iREGIST_MUL     : in     vl_logic;
        iREGIST_SDIV    : in     vl_logic;
        iREGIST_UDIV    : in     vl_logic;
        iREGIST_FLAGS_OPT_VALID: in     vl_logic;
        iREGIST_FLAGS_REGNAME: in     vl_logic_vector(3 downto 0);
        iREGIST_SOURCE0_VALID: in     vl_logic;
        iREGIST_SOURCE0 : in     vl_logic_vector(31 downto 0);
