...
add wave -noupdate /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/STAGE1_FETCH/iEXCEPTION_RESTART
...
WaveRestoreCursors {{Cursor 1} {1179 ns} 0}
...
update
WaveRestoreZoom {679 ns} {1829 ns}
