...
add wave -noupdate -expand -group {Execute - P0 Internal} -radix hexadecimal /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT0/branch_addr
add wave -noupdate -expand -group {Execute - P0 Internal} -radix hexadecimal /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT0/jump_valid
add wave -noupdate -expand -group {Execute - P0 Internal} -radix hexadecimal /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT0/not_jump_valid
add wave -noupdate -expand -group {Execute - P0 Internal} -radix hexadecimal /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT0/ib_valid
add wave -noupdate -expand -group {Execute - P0 Internal} -radix hexadecimal /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT0/idts_valid
add wave -noupdate -expand -group {Execute - P0 Internal} -radix hexadecimal /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT0/halt_valid
...
add wave -noupdate -group {Execute - P1 Prev Port} -radix hexadecimal /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT1/iPREVIOUS_EX_ALU1_DESTINATION_REGNAME
...
add wave -noupdate -group {Execute - P2 Prev Port} -radix hexadecimal /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT2/iPREVIOUS_EX_ALU2_DESTINATION_REGNAME
...
add wave -noupdate -group {Execute - P3 Prev Port} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/iPREVIOUS_EX_ALU3_VALID
add wave -noupdate -group {Execute - P3 Prev Port} -radix hexadecimal /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/iPREVIOUS_EX_ALU3_CMD
add wave -noupdate -group {Execute - P3 Prev Port} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/iPREVIOUS_EX_ALU3_COMMIT_TAG
add wave -noupdate -group {Execute - P3 Prev Port} -radix hexadecimal /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/iPREVIOUS_EX_ALU3_SOURCE0
add wave -noupdate -group {Execute - P3 Prev Port} -radix hexadecimal /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/iPREVIOUS_EX_ALU3_SOURCE1
add wave -noupdate -group {Execute - P3 Prev Port} -radix unsigned /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/iPREVIOUS_EX_ALU3_PC
add wave -noupdate -group {Execute - P3 Prev Port} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/oPREVIOUS_EX_ALU3_LOCK
...
add wave -noupdate -group {Execute - P3 Next Port} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/oSCHE1_ALU3_VALID
add wave -noupdate -group {Execute - P3 Next Port} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/oSCHE1_ALU3_COMMIT_TAG
add wave -noupdate -group {Execute - P3 Next Port} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/oSCHE2_ALU3_VALID
add wave -noupdate -group {Execute - P3 Next Port} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/oSCHE2_ALU3_COMMIT_TAG
add wave -noupdate -group {Execute - P3 Next Port} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/oSCHE2_ALU3_DESTINATION_REGNAME
add wave -noupdate -group {Execute - P3 Next Port} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/oSCHE2_ALU3_DESTINATION_SYSREG
add wave -noupdate -group {Execute - P3 Next Port} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/oSCHE2_ALU3_WRITEBACK
add wave -noupdate -group {Execute - P3 Next Port} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/oSCHE2_ALU3_DATA
add wave -noupdate -group {Execute - P3 Internal} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/store_done
add wave -noupdate -group {Execute - P3 Internal} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/load_done
add wave -noupdate -group {Execute - P3 Internal} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/spr_done
add wave -noupdate -group {Execute - P3 Internal} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/this_lock
add wave -noupdate -group {Execute - P3 Internal} /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/ldst_pipe_rw
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2817 ns} 0}
...
update
WaveRestoreZoom {2336 ns} {3752 ns}
