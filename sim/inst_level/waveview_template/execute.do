...
add wave -noupdate -group {Execute - P3 Prev Port} -radix hexadecimal /tb_inst_level/TARGET/CORE_IF/CORE_PIPELINE/SATGE7_EX_PORT3/iPREVIOUS_EX_ALU3_PC
...
WaveRestoreCursors {{Cursor 1} {2490 ns} 0}
...
update
WaveRestoreZoom {1942 ns} {4380 ns}
